...
## Building texture-packer

Building texture-packer requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
After building texture-packer, you can explore its exports at the Node console:
